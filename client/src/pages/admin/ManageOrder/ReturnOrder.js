...
import { apiDeleteOrder, apiGetOrderReturnByAdmin } from "~/apis";
...
function ReturnOrder({ location, navigate }) {
	...
	const fetchGetOrders = async (params) => {
		const response = await apiGetOrderReturnByAdmin({
			...params,
...
export default withBaseComponent(ReturnOrder);
